...
function ListTestimonials() {
  $.ajax({
    url: "http://localhost:3000/listtestimonials",
    type: "GET",
    cache: false,
    success: function(data) {

      var mainCarouselDiv = document.getElementById("testimonials-carousel");
      mainCarouselDiv.innerHTML = "";
      ...
      for (var i = 0; i < testimonials.length; i++) {
        ...
        testimonialElement.innerHTML =
          '<p class="mb-3"><i class="bx bxs-quote-alt-left quote-icon-left"></i>' 
          +  testimonials[i].testimonial 
          + '<i class="bx bxs-quote-alt-right quote-icon-right"></i></p><h4>' 
          + testimonials[i].other_info
          + '</h4><h3>'
          + testimonials[i].name
          + '</h3><h4>Age:'
          + testimonials[i].age
          + '</h4>';
        mainCarouselDiv.appendChild(testimonialElement);
      }
